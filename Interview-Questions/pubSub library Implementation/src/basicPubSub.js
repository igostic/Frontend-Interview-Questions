...
//   console.log(a + b);
// };
// const sub1 = myPubsub.subscribe("event 1", foo);
// // A different callback subscribes to the same event
// const sub2 = myPubsub.subscribe("event 1", function (a, b) {
//   console.log(a * b);
// });
// // Same callback subscribes to the the same event twice
// const sub3 = myPubsub.subscribe("event 1", foo);
// myPubsub.publish("event 1", 10, 8); // output 18, 80, 18
// sub1();
// myPubsub.publish("event 1", 10, 8); // output 80, 18
// sub2();
// myPubsub.publish("event 1", 10, 8); // output 18
